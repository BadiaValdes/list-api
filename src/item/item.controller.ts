...
import {sharpImageProcess} from './sharpImageProccesor/sharpImageProcesor'
...
export class ItemController {
  ...
  remove(@Param('id') id: string) {
    ...
    async getFileImage( @Param('imageName') imageName, @Res() res, @Query() query,) {
      ...
      sharpImageProcess(join(process.cwd(), image_destination_path, imageData.relativePath, 'original' ,imageData.originalName), imageData.originalName, res, {
        outPutFormat: "jpeg",
